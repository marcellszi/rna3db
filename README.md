...
### Download
The latest version of RNA3DB can be found under [releases](/releases/latest).

We provide the following files: 
- `rna3db-cmscans.tar.gz` [[Download](/releases/latest/download/rna3db-cmscans.tar.gz)]
    - Results of two-step Infernal homology seach on all RNA chains in the PDB
- `rna3db-jsons.tar.gz` [[Download](/releases/latest/download/rna3db-jsons.tar.gz)]
